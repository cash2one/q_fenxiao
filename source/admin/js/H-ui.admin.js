...
// write by tomatojacky
function creatIfameByTom(href,titleName){
	var bStop=false;
	var bStopIndex=0;
	var _href=href;
	var _titleName=titleName;
	var topWindow=$(window.parent.document);
	var show_navLi=topWindow.find("#min_title_list li");
	show_navLi.each(function() {
		if($(this).find('span').attr("data-href")==_href){
...
// new tab page
function tab_show(href,titleName){
	window.parent.creatIfameByTom(href,titleName);
}